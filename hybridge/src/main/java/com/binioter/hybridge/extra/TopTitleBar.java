...
public class TopTitleBar extends LinearLayout implements View.OnClickListener {
  ...
  public TopTitleBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    mBackVisible = typedArray.getBoolean(R.styleable.TopTitleBar_tb_back_icon_visible, true);
    typedArray.recycle();
    mContext = context;
    init(context);
  }
  ...
  public void setBackVisible(boolean mBackVisible) {
    mLeftText.setVisibility(mBackVisible ? View.VISIBLE : View.GONE);
  }
